...
| send_mode | Number | <optional>發送模式，1: 會員生日當月１號，2: 會員生日 N 天前 |
| valid_days | Number | <optional>會員生日 N 天前，0 表示無限期 |
...
| gift_score.time_config.expire_time | String | 指定到期日（格式：YYYY-MM-DD HH:mm:ss） |
...
| gift_coupon.offline_store_range.store_list | Array | 門市 ID 列
